  ...
  <div class="container-fluid mega-options">
    <div class="row">
      <div class="col-sm-12 col-xl-6 box-col-6">
        <div class="card">
          <div class="card-header pb-0">
            <h4>Default Style</h4><span>This option is show buydefault you don't need to add any extra class</span>
          </div>
      ...
      <div class="col-sm-12 col-xl-6 box-col-6">
        <div class="card">
          <div class="card-header pb-0">
            <h4>Offer style Border</h4><span>By adding .offer-style class to .mega-inline You can archive this style</span>
          </div>
          <div class="card-body megaoptions-border-space-sm">
      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header pb-0">
            <h4>Inline Style</h4><span>For Create inline megaoption add <code>.mega-inline</code> class in form tag</span>
          </div>
          <div class="card-body megaoptions-border-space-sm">
            <form class="mega-inline">
              <div class="row">
                <div class="col-sm-6">
                  <div class="card">
                    <div class="d-flex p-20">
                      ...
                      <div class="flex-grow-1">
                        <h6 class="mt-0 mega-title-badge">COD<span class="badge badge-primary pull-right digits">50 INR</span></h6>
                        <p class="mb-0">Estimated 14-20 Day Shipping ( Duties end taxes may be due upon delivery )</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="card">
                    <div class="d-flex p-20">
                      ...
                      <div class="flex-grow-1">
                        <h6 class="mt-0 mega-title-badge">Fast<span class="badge badge-secondary pull-right digits">100 INR</span></h6>
                        <p class="mb-0">Estimated 1 Day Shipping ( Duties end taxes may be due upon delivery )</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card">
                    <div class="d-flex p-20">
                      ...
                      <div class="flex-grow-1">
                        ...
                        <p class="mb-0">Estimated 3 Day Shipping ( Duties end taxes may be due upon delivery )</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card">
                    <div class="d-flex p-20">
                      ...
                      <div class="flex-grow-1">
                        ...
                        <p class="mb-0">Estimated 15 Day Shipping ( Duties end taxes may be due upon delivery )</p>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <div class="col-sm-12 col-xl-6 box-col-6">
        <div class="card height-equal">
          <div class="card-header pb-0">
            <h4>Vertical Style</h4><span>For Create inline megaoption add <code>.mega-vertical</code> class in form tag</span>
          </div>
          <div class="card-body">
            <form class="mega-vertical">
              <div class="row">
                <div class="col-sm-12">
                  <p class="mega-title mb-3">Delivery Option</p>
                </div>
                <div class="col-sm-6">
                  <div class="card">
                    <div class="d-flex p-20">
                      ...
                      <div class="flex-grow-1">
                        <h6 class="mt-0 mega-title-badge">COD<span class="badge badge-primary pull-right digits">50 INR</span></h6>
                        <p class="mb-0">Estimated 10 to 15 Day Shipping ( Duties end tax may be due delivery )</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="card">
                    <div class="d-flex p-20">
                      ...
                      <div class="flex-grow-1">
                        <h6 class="mt-0 mega-title-badge">Fast <span class="badge badge-secondary pull-right digits">100 INR</span></h6>
                        <p class="mb-0">Estimated 10 to 12 Day Shipping ( Duties end tax may be due delivery )</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card">
                    <div class="d-flex p-20">
                      ...
                      <div class="flex-grow-1">
                        ...
                        <p class="mb-0">Estimated 3 to 5 Day Shipping ( Duties end tax may be due delivery )</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card">
                    <div class="d-flex p-20">
                      ...
                      <div class="flex-grow-1">
                        ...
                        <p class="mb-0">Estimated 3 to 5 Day Shipping ( Duties end taxes may be due upon delivery )</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-sm-12">
                  <p class="mega-title mb-3">Buying Option</p>
                </div>
                <div class="col-sm-6">
                  <div class="card">
                    <div class="d-flex p-20">
                      ...
                      <div class="flex-grow-1">
                        ...
                        <p class="rating-star-wrapper mb-0"><i class="icofont icofont-star txt-warning"></i><i class="icofont icofont-star txt-warning"></i><i class="icofont icofont-star txt-warning"></i><i class="icofont icofont-star txt-warning"></i><i class="icofont icofont-star txt-warning m-r-5"></i>5 start rating</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card">
                    <div class="d-flex p-20">
                      ...
                      <div class="flex-grow-1">
                        ...
                        <p class="rating-star-wrapper mb-0"><i class="icofont icofont-star txt-warning"></i><i class="icofont icofont-star"></i><i class="icofont icofont-star"></i><i class="icofont icofont-star"></i><i class="icofont icofont-star m-r-5"></i>1 start rating</p>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <div class="col-sm-12 col-xl-6 box-col-6">
        <div class="card height-equal">
          <div class="card-header pb-0">
            <h4>Horizontal Style</h4><span>For Create inline megaoption add <code>.mega-horizontal</code> class in form tag</span>
          </div>
          <div class="card-body">
                ...
                <div class="col-sm-9">
                  <div class="card">
                    <div class="d-flex p-20">
                      ...
                      <div class="flex-grow-1">
                        <h6 class="mt-0 mega-title-badge">COD<span class="badge badge-primary pull-right digits">50 INR</span></h6>
                        <p class="mb-0">Estimated 5 Day Shipping ( Duties end tax may be due delivery )</p>
                      </div>
                    </div>
                  </div>
                </div>
