                                    ...
                                    <table class="table table-bordered">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><span>Alerts are available for any length of text, as well as an
                                                        optional dismiss button. Add <code> alert
                                                            alert-primary</code>,<code> alert alert-secondary</code>,<code>
                                                            alert alert-success</code>,<code> alert alert-info</code>
                                                        classes for alert with all template colors.</span></td>
                                            </tr>
                                            <tr>
                                                <td>Alerts with Links</td>
                                                <td>
                                                    <div class="alert alert-primary">
                                                        <p><strong>Success!</strong> You should <a class="alert-link"
                                    ...
                                    <table class="table table-bordered">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><span>Use <code>a href="javascript:void(0)"</code> for link trigger.
                                                        This is a link trigger</span></td>
                                            </tr>
                                            <tr>
