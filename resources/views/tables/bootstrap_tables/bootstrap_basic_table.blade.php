          ...
          <table class="table">
            ...
            <tbody>
              <tr class="border-bottom-secondary">
                <th scope="row">1</th>
                <td> <img class="img-30 me-2" src="{{ asset('assets/images/dashboard/default/01.png') }}" alt="">Ram Jacob</td>
                <td>Wolfe</td>
              ...
              <tr class="border-bottom-success">
                <th scope="row">2</th>
                <td> <img class="img-30 me-2" src="{{ asset('assets/images/dashboard/default/02.png') }}" alt="">John Deo</td>
                <td>Gummer</td>
              ...
              <tr class="border-bottom-info">
                <th scope="row">3</th>
                <td> <img class="img-30 me-2" src="{{ asset('assets/images/dashboard/default/03.png') }}" alt="">Elana John</td>
                <td>Cazale	</td>
              ...
              <tr class="border-bottom-warning">
                <th scope="row">4</th>
                <td> <img class="img-30 me-2" src="{{ asset('assets/images/dashboard/default/04.png') }}" alt="">Meryl Streep</td>
                <td>Roberts</td>
              ...
              <tr class="border-bottom-danger">
                <th scope="row">5</th>
                <td> <img class="img-30 me-2" src="{{ asset('assets/images/dashboard/default/05.png') }}" alt="">Emma Stone</td>
                <td>Stone</td>
              ...
              <tr class="border-bottom-light"> 
                <th scope="row">6</th>
                <td> <img class="img-30 me-2" src="{{ asset('assets/images/dashboard/default/01.png') }}" alt="">Eliana Jons</td>
                <td>Jons</td>
